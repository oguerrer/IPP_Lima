...
el escenario Covid planteado en el reporte pero con el presupuesto optimizado. 
Se guardan las dinámicas promedio de los indicadores y las asignaciones 
presupuestales inferidas.
